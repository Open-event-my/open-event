...
class ComplianceVerifier {
  ...
  private addResult(feature: string, passed: boolean, message: string, details?: any) {
    ...
    try {
      ...
      if (exportService.exportUserData) {
        this.addResult(
          'Data Export Service',
          true,
          'Data export service is implemented'
        );
      } else {
        this.addResult(
          'Data Export Service',
      ...
      if (exportComponent.DataExportSection) {
        this.addResult(
          'Data Export UI',
          true,
          'Data export UI component is implemented'
        );
      } else {
        this.addResult(
          'Data Export UI',
          false,
          'Data export UI component is missing'
        );
      }
      ...
      try {
        ...
        this.addResult(
          ...
          true,
          'Property test for data export exists'
        );
      } catch {
        this.addResult(
          'Data Export Property Test',
    ...
    try {
      ...
      if (deletionService.deleteUserData) {
        this.addResult(
          ...
          true,
          'Data deletion service is implemented'
        );
      } else {
        this.addResult(
          'Data Deletion Service',
      ...
      if (deletionComponent.DataDeletionSection) {
        this.addResult(
          'Data Deletion UI',
          true,
          'Data deletion UI component is implemented'
        );
      } else {
        this.addResult(
          'Data Deletion UI',
          false,
          'Data deletion UI component is missing'
        );
      }
    ...
    try {
      ...
      if (auditService.logAuditEvent) {
        this.addResult(
          'Audit Log Service',
          true,
          'Audit log service is implemented'
        );
      } else {
        this.addResult(
          'Audit Log Service',
      ...
      if (auditMiddleware.withAuditLog) {
        this.addResult(
          ...
          true,
          'Audit log middleware is implemented'
        );
      } else {
        this.addResult(
          'Audit Log Middleware',
          false,
          'Audit log middleware is missing'
        );
      }
      ...
      try {
        ...
        this.addResult(
          ...
          true,
          'Property test for audit logging exists'
        );
      } catch {
        this.addResult(
          'Audit Log Property Test',
      ...
      try {
        ...
        this.addResult(
          'Audit Logging Guide',
          true,
          'Audit logging guide documentation exists'
        );
      } catch {
        this.addResult(
          'Audit Logging Guide',
          false,
          'Audit logging guide documentation is missing'
        );
      }
    ...
    try {
      ...
      if (consentBanner.CookieConsentBanner) {
        ...
        this.addResult(
          'Cookie Consent Banner',
          false,
          'Cookie consent banner component is missing'
        );
      }
      ...
      if (consentPrefs.CookiePreferences) {
        ...
        this.addResult(
          'Cookie Preferences UI',
          false,
          'Cookie preferences UI component is missing'
        );
      }
    ...
    try {
      ...
      if (termsService.recordTermsAcceptance) {
        this.addResult(
          ...
          true,
          'Terms acceptance service is implemented'
        );
      } else {
        this.addResult(
          'Terms Acceptance Service',
    ...
    try {
      ...
      if (retentionService.cleanupExpiredData) {
        this.addResult(
          ...
          true,
          'Data retention service is implemented'
        );
      } else {
        this.addResult(
          'Data Retention Service',
