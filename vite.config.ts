  ...
  server: {
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        "connect-src 'self' http://localhost:* http://127.0.0.1:* https://*.convex.cloud https://*.convex.site https://api.openai.com https://api.stripe.com wss://*.convex.cloud wss://*.convex.site",
  ...
  preview: {
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        "img-src 'self' data: https: blob:",
        "font-src 'self' data: https://cdn.jsdelivr.net",
        "connect-src 'self' https://*.convex.cloud https://*.convex.site https://api.openai.com https://api.stripe.com wss://*.convex.cloud wss://*.convex.site",
        "frame-ancestors 'none'",
        "base-uri 'self'",
        "form-action 'self'",
      ].join('; '),
