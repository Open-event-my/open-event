    ...
    it('should reject all requests exceeding the maximum body size limit', () => {
      fc.assert(
        fc.property(
          ...
          fc.integer({
            min: REQUEST_SIZE_CONFIG.maxBodySize + 1,
            max: REQUEST_SIZE_CONFIG.maxBodySize * 2,
          }),
          (requestSize) => {
    ...
    it('should reject JSON payloads exceeding the JSON size limit', () => {
      fc.assert(
        fc.property(
          ...
          fc.integer({
            min: REQUEST_SIZE_CONFIG.maxJsonSize + 1,
            max: REQUEST_SIZE_CONFIG.maxJsonSize * 2,
          }),
          (requestSize) => {
    ...
    it('should reject file uploads exceeding the file upload size limit', () => {
      fc.assert(
        fc.property(
          ...
          fc.integer({
            min: REQUEST_SIZE_CONFIG.maxFileSize + 1,
            max: REQUEST_SIZE_CONFIG.maxFileSize + 10 * 1024 * 1024,
          }),
          (requestSize) => {
    ...
    it('should handle requests without Content-Length header gracefully', () => {
      fc.assert(
        fc.property(
          ...
          fc.constantFrom('application/json', 'multipart/form-data', 'text/plain', undefined),
          (contentType) => {
