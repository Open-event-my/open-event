...
/**
 * Context type for rate limiting operations
 */
...
export interface RateLimitConfig {
  ...
  keyGenerator?: (ctx: RateLimitContext) => string // Custom key generator function
}
 ...
 */
export function generateRateLimitKey(ctx: RateLimitContext, type: string = 'default'): string {
...
/**
 * Generic handler function type for rate limiting
 */
type RateLimitHandler<TArgs extends unknown[], TReturn> = (
...
export function withRateLimit<TArgs extends unknown[], TReturn>(
  handler: RateLimitHandler<TArgs, TReturn>,
  config: RateLimitConfig
): RateLimitHandler<TArgs, TReturn> {
  return (async (ctx: RateLimitContext, ...args: TArgs) => {
  ...
  }) as RateLimitHandler<TArgs, TReturn>
}
